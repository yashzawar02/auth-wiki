...
- [OpenAPI Specification](https://swagger.io/specification/): A standard way to define RESTful APIs.
- [GraphQL and REST API](https://blog.logto.io/graphql-and-rest-api): A comparison between GraphQL and REST API.
- [Post-only debate](https://blog.logto.io/post-only-debate): A discussion on the debate between RESTful and RPC-style APIs.
