...
From <Ref slug="oauth-2.1" />, PKCE is enforced for all types of clients, including <Ref slug="client" headingId="public-clients" /> and <Ref slug="client" headingId="confidential-clients">confidential (private) clients</Ref>.
