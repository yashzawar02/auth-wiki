export const de = Object.freeze({
  ...
  site: {
    description: 'Auth Wiki ist eine umfassende Sammlung von Ressourcen zu Authentifizierung, Autorisierung und Identitäts- und Zugriffsverwaltung. Erfahren Sie mehr über OAuth 2.0, OpenID Connect, SAML.',
  },
  home: {
