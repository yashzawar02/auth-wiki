export const nl = Object.freeze({
  ...
  site: {
    description: 'Auth Wiki is een uitgebreide verzameling bronnen over authenticatie, autorisatie en identiteits- en toegangsbeheer. Leer over OAuth 2.0, OpenID Connect, SAML.',
  },
  home: {
  ...
  content: {
    ...
    see_also: 'Zie ook',
    resources_and_references: 'Bronnen en referenties',
  }
});
