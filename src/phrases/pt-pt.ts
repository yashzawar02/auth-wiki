export const ptPt = Object.freeze({
  general: {
    share: 'Compartilhar',
    learn_more: 'Saiba mais',
  },
  site: {
    description: 'Auth Wiki é uma coleção abrangente de recursos sobre autenticação, autorização e gerenciamento de identidade e acesso. Aprenda sobre OAuth 2.0, OpenID Connect, SAML.',
  },
  home: {
  ...
  content: {
    ...
    resources_and_references: 'Recursos e referências',
  }
});
